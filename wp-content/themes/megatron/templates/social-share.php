...
?>
    <div class="social-share-wrap">
        <a class="m-button m-button-3d m-button-gray m-button-xs" href="javascript:;" rel="bookmark" title="<?php the_title(); ?>"><?php esc_html_e('Share','g5plus-megatron') ?> <i class="micon icon-share"></i></a>
