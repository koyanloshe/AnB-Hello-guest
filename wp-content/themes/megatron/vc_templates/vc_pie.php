...
wp_enqueue_script('megatron_vc_pie_chart_js', G5PLUS_THEME_URL . 'assets/vc-extend/js/jquery.vc_chart' . $min_suffix_js . '.js', array(), false, true);
wp_enqueue_style('megatron_vc_pie_chart_css', G5PLUS_THEME_URL . 'assets/vc-extend/css/vc_chart' . $min_suffix_css . '.css', array(), false);
$primary_color='';
