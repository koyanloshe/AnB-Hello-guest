...
<?php if ($product_new == 'yes') : ?>
    <span class="on-new product-flash"><?php esc_html_e('New','g5plus-megatron') ?></span>
<?php endif; ?>

<?php if ($product_hot == 'yes') : ?>
    <span class="on-hot product-flash"><?php esc_html_e('Hot','g5plus-megatron') ?></span>
<?php endif; ?>

<?php if (!$product->is_in_stock()) : ?>
    <span class="on-sold product-flash"><?php esc_html_e('Sold','g5plus-megatron') ?></span>
<?php endif; ?>
