...
$cart_totals_inner_class =  'cart_totals_inner col-lg-5 col-lg-offset-3 col-xs-12 col-md-6';
if ( get_option( 'woocommerce_enable_shipping_calc' ) === 'no' || ! WC()->cart->needs_shipping() ) {
	$cart_totals_inner_class =  'cart_totals_inner col-lg-5 col-lg-offset-7 col-xs-12 col-md-6';
}
