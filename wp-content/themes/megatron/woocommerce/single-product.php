...
$bottom_sidebar = isset($g5plus_options['single_product_bottom_sidebar']) ? $g5plus_options['single_product_bottom_sidebar'] : '';
...
<main  class="<?php echo join(' ',$main_class) ?>">
    ...
    <?php if (!empty($bottom_sidebar) && is_active_sidebar($bottom_sidebar )): ?>
